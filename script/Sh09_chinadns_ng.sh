...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -b :: -c ::#8051,udp://223.5.5.5 -t ::#8054,tcp://198.18.0.1 -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt,/opt/ad.txt -g /opt/app/chinadns_ng/gfwlist.txt,/opt/ipv4.txt ' && nvram set app_107="$smartdns_usage"

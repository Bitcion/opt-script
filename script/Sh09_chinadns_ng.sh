...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -b :: -c tcp://::#8051,udp://2409:803c:2000:1::26 -t ::#8054,198.18.0.2 -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt,/opt/ad.txt -g /opt/app/chinadns_ng/gfwlist.txt,/opt/ipv4.txt -C /opt/adv6.txt ' && nvram set app_107="$smartdns_usage"

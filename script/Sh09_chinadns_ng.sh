...
[ -z "$smartdns_usage" ] && smartdns_usage=' -d gfw -M --cache 0 -b :: -c ::#8051,udp://::#8054,198.18.0.2 -t udp://::#8054,198.18.0.2 --chnlist-first -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt -g /opt/app/chinadns_ng/gfwlist.txt,/opt/quic.txt ' && nvram set app_107="$smartdns_usage"

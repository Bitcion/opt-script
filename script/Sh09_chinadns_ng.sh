...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -C /opt/adv6.txt -b :: -c ::#8051,tcp://223.5.5.5 -t ::#8054,tcp://fdfe:dcba:9876::2 -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt -g /opt/app/chinadns_ng/gfwlist.txt,/opt/quic.txt ' && nvram set app_107="$smartdns_usage"

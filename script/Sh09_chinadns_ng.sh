...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -b :: -c ::#8051 -t ::#8054,198.18.0.2 -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt -g /opt/app/chinadns_ng/gfwlist.txt,/opt/quic.txt -C /opt/adv6.txt ' && nvram set app_107="$smartdns_usage"

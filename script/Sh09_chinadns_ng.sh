...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -d chn -b :: -c 2409:803C:2000:4::131,2409:803c:2000:1::26,198.18.0.2 -t ::#8054,198.18.0.2 --chnlist-first -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt,/opt/ad.txt -g /opt/app/chinadns_ng/gfwlist.txt ' && nvram set app_107="$smartdns_usage"

...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -C /opt/adv6.txt -b :: -c ::#8051 -t ::#8054,tcp://198.18.0.2 -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt -g /opt/app/chinadns_ng/gfwlist.txt,/opt/quic.txt ' && nvram set app_107="$smartdns_usage"

...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -d chn -b :: -c ::#8051,198.18.0.2 -t ::#8054,198.18.0.2 --chnlist-first -m /opt/app/chinadns_ng/chnlist.txt -g /opt/app/chinadns_ng/gfwlist.txt ' && nvram set app_107="$smartdns_usage"

...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -C /opt/adv6.txt -b :: -c ::#8051,udp://1.2.4.8 -t ::#8054,tcp://fdfe:dcba:9876::2 -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt -g /opt/app/chinadns_ng/gfwlist.txt,/opt/quic.txt ' && nvram set app_107="$smartdns_usage"

...
[ -z "$smartdns_usage" ] && smartdns_usage=' -M -d chn --cache 0 -b :: -c 2409:803C:2000:4::131,2409:803c:2000:1::26,223.5.5.5 -t ::#8054,fdfe:dcba:9876::2,fdfe:dcba:9876::3 --chnlist-first -m /opt/app/chinadns_ng/chnlist.txt,/opt/cn.txt,/opt/ad.txt -g /opt/app/chinadns_ng/gfwlist.txt ' && nvram set app_107="$smartdns_usage"
